...
public:
	virtual void OnLoadingStateChange([[maybe_unused]] CefRefPtr<CefBrowser> browser,
					  [[maybe_unused]] bool isLoading, [[maybe_unused]]  bool canGoBack,
					  [[maybe_unused]] bool canGoForward)
	{
		/*
		UNUSED_PARAMETER(browser);
		UNUSED_PARAMETER(isLoading);
		UNUSED_PARAMETER(canGoBack);
		UNUSED_PARAMETER(canGoForward);
		*/
	}
