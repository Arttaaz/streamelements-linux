...
void StreamElementsApiMessageHandler::RegisterIncomingApiCallHandlers()
{
	...
	API_HANDLER_BEGIN("addCurrentSceneItemBrowserSource");
	{
		...
		if (args->GetSize()) {
			CefRefPtr<CefValue> val = CefRefPtr(args->GetValue(0));
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->DeserializeObsBrowserSource(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("addCurrentSceneItemGameCaptureSource");
	{
		...
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->DeserializeObsGameCaptureSource(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("addCurrentSceneItemVideoCaptureSource");
	{
		...
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->DeserializeObsVideoCaptureSource(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("addCurrentSceneItemObsNativeSource");
	{
		...
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->DeserializeObsNativeSource(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("addCurrentSceneItemGroup");
	{
		...
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->DeserializeObsSceneItemGroup(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("getAllCurrentSceneItems");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->SerializeObsSceneItems(val, result);
		} else {
	...
	API_HANDLER_BEGIN("removeCurrentSceneItemsByIds");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->RemoveObsSceneItemsByIds(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("invokeCurrentSceneItemDefaultActionById");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->InvokeCurrentSceneItemDefaultActionById(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("invokeCurrentSceneItemDefaultContextMenuById");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->InvokeCurrentSceneItemDefaultContextMenuById(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("setCurrentSceneItemsAuxiliaryActions");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->DeserializeSceneItemsAuxiliaryActions(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("setScenesAuxiliaryActions");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->DeserializeScenesAuxiliaryActions(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("setCurrentSceneItemPropertiesById");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->SetObsSceneItemPropertiesById(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("ungroupCurrentSceneItemGroupById");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->UngroupObsSceneItemsByGroupId(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("getSourceClassProperties");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->SerializeSourceClassProperties(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("getExternalSceneDataSceneCollections");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetExternalSceneDataProviderManager()
				->SerializeProviderSceneCollections(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("getExternalSceneDataSceneCollectionContent");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetExternalSceneDataProviderManager()
				->SerializeProviderSceneColletion(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("httpRequestText");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetHttpClient()
				->DeserializeHttpRequestText(val, result);
		}
	}
	API_HANDLER_END();
		...
		if (args->GetSize()) {
			...
			result->SetBool(
				StreamElementsGlobalStateManager::GetInstance()
					...
					->DeserializeStartStreamingUIHandlerProperties(val));
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("setUserInterfaceState");
	{
		if (args->GetSize()) {
			...
			result->SetBool(
				StreamElementsGlobalStateManager::GetInstance()
					->DeserializeUserInterfaceState(val));
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("addScene");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->DeserializeObsScene(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("setCurrentSceneById");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->SetCurrentObsSceneById(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("removeScenesByIds");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->RemoveObsScenesByIds(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("setScenePropertiesById");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->SetObsScenePropertiesById(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("setCurrentProfile");
	{
		if (args->GetSize()) {
			...
			result->SetBool(
				StreamElementsGlobalStateManager::GetInstance()
					->GetProfilesManager()
					->DeserializeCurrentProfileById(val));
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("addSceneCollection");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->DeserializeObsSceneCollection(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("setCurrentSceneCollectionById");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetObsSceneManager()
				->DeserializeObsCurrentSceneCollectionById(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("createUserEnvironmentBackupPackage");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetBackupManager()
				->CreateLocalBackupPackage(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("queryUserEnvironmentBackupPackageContent");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetBackupManager()
				->QueryBackupPackageContent(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("restoreUserEnvironmentBackupPackageContent");
	{
		if (args->GetSize()) {
			...
			StreamElementsGlobalStateManager::GetInstance()
				->GetBackupManager()
				->RestoreBackupPackageContent(val, result);
		}
	}
	API_HANDLER_END();
	...
	API_HANDLER_BEGIN("dispatchKeyboardEvent");
	{
		if (args->GetSize()) {
			...
			if (DeserializeCefKeyEvent(val, keyEvent)) {
