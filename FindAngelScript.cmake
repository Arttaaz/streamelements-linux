...
SET(ANGELSCRIPT_ROOT_DIR "../../../angelscript/" CACHE PATH "Path to AngelScript SDK")

if(CMAKE_SIZEOF_VOID_P EQUAL 8)
	# 64 bits
	message("Looking for angelscript.lib in ${ANGELSCRIPT_ROOT_DIR}/sdk/angelscript/lib")
	find_library(ANGELSCRIPT_LIBRARY
		NAMES libangelscript.so "AngelScript"
		PATHS ${ANGELSCRIPT_ROOT_DIR}/sdk/angelscript/lib)
